namespace RD.Framework.main.RDFood.RDButcher.Recipies.PreparedMeats
{
    ...
    public partial class RawMeatFromAngusSteakRecipe : RecipeFamily
    {
        public RawMeatFromAngusSteakRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawMeatFromAngusSteakRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Prepare Raw Meat From Angus Steak"), recipeType: typeof(RawMeatFromAngusSteakRecipe));
