namespace RD.Framework.main.RDFood.RDButcher.Recipies.PreparedMeats
{
    ...
    public partial class RawMeatFromBeefRoastRecipe : RecipeFamily
    {
        public RawMeatFromBeefRoastRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(RawMeatFromBeefRoastRecipe), start: 1.5f, skillType: typeof(ButcherySkill), typeof(ButcheryFocusedSpeedTalent), typeof(ButcheryParallelSpeedTalent));
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Prepare Raw Meat From Beef Roast"), recipeType: typeof(RawMeatFromBeefRoastRecipe));
