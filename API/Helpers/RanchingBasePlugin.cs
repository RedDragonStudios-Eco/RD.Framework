...
namespace RD.Framework.API.Helpers
{
    public class FarmingBasePlugin : IModKitPlugin, IModInit
    {
        ...
        public static void Initialize()
        {
            ...
            turkeyList.Add(new SpeciesResource(typeof(BabyTurkeyItem), new Range(1, 3), 0.1f));
            ...
            agoutiList.Add(new SpeciesResource(typeof(BabyAgoutiItem), new Range(1, 3), 0.1f));
