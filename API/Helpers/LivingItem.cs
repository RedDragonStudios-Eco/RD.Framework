/**namespace RD.Framework.API.Helpers
{
    ...
    public LivingItem() {}
        ...
        public Item Merge(Item item, int first, int second)
        {
            ...
            if (item.Type != Type) throw new Exception("Trying to Merge Different Animals, this shouldn't be possible");
        ...
        float GetDeathTimeBasedOnDurability(ImmutableCountdown DeathTimer) => DeathTimer.PercentLeft() * 100f;
